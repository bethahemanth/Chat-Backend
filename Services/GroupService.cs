            ...
            query.Values.Add(new List<string>()
    {
       // Add group_id, assuming it's an integer type
                ...
                Conditions = new List<string>()
        {
            ...
            return _repo.GetRecords<User>(query);  // This will return the list of users in the group
        }
        public int GetGroupIdByMemberId(int user_id)
        {
            Query query = new Query()
            {
                ...
                Conditions = new List<string>()
        {
            ...
            var result = _repo.GetRecords<int>(query);  // Assuming the query will return group IDs
            return result.FirstOrDefault();  // Return the first group ID the user is part of (if any)
        }
